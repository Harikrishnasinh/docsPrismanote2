...
const sidebar: SidebarsConfig = {
  apisidebar: [
    {
      type: "doc",
      id: "api/supplier/supplier-b-2-b-app",
    },
    {
      type: "category",
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/1-supplier-business-partners-list",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/2-supplier-stock-list",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/3-supplier-sales-list",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/4-transaction-list",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/5-shared-transaction-list",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/6-shared-transaction-create",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/7-shared-transaction-detail",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/8-shared-transaction-detail-test-1-version",
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "api/supplier/9-shared-transaction-detail-test-2-version",
          label: "9. Shared Transaction detail test 2 version",
          className: "api-method get",
        },
      ],
    },
